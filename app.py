...
def requested():
    ...
    phone=[]
    for i in a:
        url="https://www.fast2sms.com/dev/bulkV2?authorization=QYP4z0c4zufMWoKofSlS9voIP1feAj9I7S5ikgIEpZnVGuIDOKrozMgVfKkf&sender_id=TXTIND&message=Need plasma of your blood.&route=v3&numbers="+str(i['phone'])
